# DT207G Projekt - Buster pizzeria
Webbtjänst för att visa och administrera restaurangmeny samt bordsbokningar. Byggt med Express, MongoDB Atlas och Mongoose. JWT används för autentisering och bcrypt för hashning av lösenord.
...
## Länk
https://dt207g-project-backend-hbda.onrender.com/api/menu
...
| GET | /api/menu/:id | Hämtar en maträtt - Skyddad route |
